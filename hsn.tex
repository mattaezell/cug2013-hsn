...
Sometime after the slow modules were removed, the problematic acceptance
applications were rerun on Titan.  Application specialist reported that the S3D
application ran ``significantly faster'' than previously, but it's not clear
how much improvement was due to the removal of the slow modules.
